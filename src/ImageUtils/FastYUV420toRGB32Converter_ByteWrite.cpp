...
FILE NAME					: FastYUV420toRGB32Converter.cpp
...
#include "FastYUV420toRGB32Converter.h"
...
===========================================================================
*/
#define FYUVRGB32C_RANGECHECK_0TO255(x) ( (((x) <= 255)&&((x) >= 0))?((x)):( ((x) > 255)?(255):(0) ) )
...
===========================================================================
*/
void FastYUV420toRGB32Converter::NonRotateConvert(VICS_PSBYTE pY,VICS_PSBYTE pU,VICS_PSBYTE pV,VICS_POINTER pRgb)
{
  ...
  VICS_INT r,b,g;
	...
	VICS_INT rgb1row  = (_width * 4);
	VICS_INT rgb2rows = (_width * 4) << 1;
...
//			VICS_INT ca =  (v >> 2) + (v >> 5) - 144;
  		...
  		// Fast calculation with 6 bit to 8 bit conversion built in. 
			...
			optr[rgbpos0++] = (VICS_BYTE)(FYUVRGB32C_RANGECHECK_0TO255(b));
			optr[rgbpos0++] = (VICS_BYTE)(FYUVRGB32C_RANGECHECK_0TO255(g));
			optr[rgbpos0++] = (VICS_BYTE)(FYUVRGB32C_RANGECHECK_0TO255(r));
			optr[rgbpos0++] = (VICS_BYTE)(0);
			...
			optr[rgbpos1++] = (VICS_BYTE)(FYUVRGB32C_RANGECHECK_0TO255(b));
			optr[rgbpos1++] = (VICS_BYTE)(FYUVRGB32C_RANGECHECK_0TO255(g));
			optr[rgbpos1++] = (VICS_BYTE)(FYUVRGB32C_RANGECHECK_0TO255(r));
			optr[rgbpos1++] = (VICS_BYTE)(0);
...
void FastYUV420toRGB32Converter::RotateConvert(VICS_PSBYTE pY,VICS_PSBYTE pU,VICS_PSBYTE pV,VICS_POINTER pRgb)
{
	VICS_BYTE* 	optr	=	(VICS_BYTE *)pRgb;
	VICS_INT		lumX	= _width;
	VICS_INT		lumY	= _height;
  ...
  VICS_INT r,b,g;
	...
	VICS_INT tworows  = lumX << 1;
	VICS_INT rgb1row  = (_height * 4);

	for(y = 0,lumposy = 0,uvposy = 0,rgbposx = 0;	y < lumY;	y += 2,lumposy += tworows,uvposy += uvX,rgbposx += 8)
	{
		VICS_INT lumpos0 = lumposy;					// Reset to start of rows.
		VICS_INT lumpos1 = lumposy + lumX;
		VICS_INT uvpos	 = uvposy;
...
//			VICS_INT ca =  (v >> 2) + (v >> 5) - 144;
  		...
  		// Fast calculation with 6 bit to 8 bit conversion built in. 
			...
			// R, G & B have range 0..255.
			optr[rgbpos0]		= (VICS_BYTE)(FYUVRGB32C_RANGECHECK_0TO255(b));
			optr[rgbpos0+1] = (VICS_BYTE)(FYUVRGB32C_RANGECHECK_0TO255(g));
			optr[rgbpos0+2] = (VICS_BYTE)(FYUVRGB32C_RANGECHECK_0TO255(r));
			optr[rgbpos0+3] = (VICS_BYTE)(0);
			rgbpos0 += rgb1row;
			...
			optr[rgbpos1]		= (VICS_BYTE)(FYUVRGB32C_RANGECHECK_0TO255(b));
			optr[rgbpos1+1] = (VICS_BYTE)(FYUVRGB32C_RANGECHECK_0TO255(g));
			optr[rgbpos1+2] = (VICS_BYTE)(FYUVRGB32C_RANGECHECK_0TO255(r));
			optr[rgbpos1+3] = (VICS_BYTE)(0);
			rgbpos1 += rgb1row;
