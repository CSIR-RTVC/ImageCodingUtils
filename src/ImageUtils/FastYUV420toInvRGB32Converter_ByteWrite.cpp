...
FILE NAME					: FastYUV420toInvRGB32Converter.cpp
	...
	for(y = 0,lumposy = 0,uvposy = 0,rgbposy = ((_height-1)*rgb1row);	y < lumY;	y += 2,lumposy += tworows,uvposy += uvX,rgbposy -= rgb2rows)
	{
		...
		for(x = 0; x < lumX; x += 2)
		{
  		...
  		// Fast calculation with 6 bit to 8 bit conversion built in. 
			...
			optr[rgbpos0++] = (VICS_BYTE)(FYUVIRGB32C_RANGECHECK_0TO255(b));
			optr[rgbpos0++] = (VICS_BYTE)(FYUVIRGB32C_RANGECHECK_0TO255(g));
			optr[rgbpos0++] = (VICS_BYTE)(FYUVIRGB32C_RANGECHECK_0TO255(r));
			...
			// R, G & B have range 0..255.
			optr[rgbpos1++] = (VICS_BYTE)(FYUVIRGB32C_RANGECHECK_0TO255(b));
			optr[rgbpos1++] = (VICS_BYTE)(FYUVIRGB32C_RANGECHECK_0TO255(g));
			optr[rgbpos1++] = (VICS_BYTE)(FYUVIRGB32C_RANGECHECK_0TO255(r));
...
//			VICS_INT ca =  (v >> 2) + (v >> 5) - 144;
  		...
  		// Fast calculation with 6 bit to 8 bit conversion built in. 
			...
			// R, G & B have range 0..255.
			optr[rgbpos0]		= (VICS_BYTE)(FYUVIRGB32C_RANGECHECK_0TO255(b));
			optr[rgbpos0+1] = (VICS_BYTE)(FYUVIRGB32C_RANGECHECK_0TO255(g));
			optr[rgbpos0+2] = (VICS_BYTE)(FYUVIRGB32C_RANGECHECK_0TO255(r));
			...
			optr[rgbpos1]		= (VICS_BYTE)(FYUVIRGB32C_RANGECHECK_0TO255(b));
			optr[rgbpos1+1] = (VICS_BYTE)(FYUVIRGB32C_RANGECHECK_0TO255(g));
			optr[rgbpos1+2] = (VICS_BYTE)(FYUVIRGB32C_RANGECHECK_0TO255(r));
